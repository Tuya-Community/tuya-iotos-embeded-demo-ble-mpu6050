...
In this demo, we will show you how to use mpu6050 driver, and view the data acquisition results through the serial tool. This Demo is an application developed based on the Tuya Bluetooth Low Energy module and Tuya SDK. You can also create smart products on [Tuya IoT Platform](https://iot.tuya.com/) and use the Tuya Smart APP To control your device.
...
|    └── tuya_mpu_daq.h                    /* MPU6050 data acquisition */
└── src
     ├── driver
     ...
     └── tuya_mpu_daq.c                    /* MPU6050 data acquisition */
```
...
+ `tuya_mpu_daq_init()` is run to initialize the mpu6050 data acquisition program.
